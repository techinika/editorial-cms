...
export default function BytesClient({ user }: BytesClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Modal open={showEditModal} onClose={() => setShowEditModal(false)} title={editingByte ? "Edit Quick Byte" : "Create Quick Byte"} className="bg-white rounded-lg shadow-xl p-6 w-full max-w-3xl mx-4 max-h-[90vh] overflow-y-auto">
      ...
      <Modal open={showDeleteModal} onClose={() => setShowDeleteModal(false)} title="Delete Quick Byte" className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
