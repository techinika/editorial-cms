...
export default function AssetEditModal({ isOpen, onClose, asset, user, onSave }: AssetEditModalProps) {
  ...
  return (
    <Modal open={isOpen} onClose={onClose} title={isEditing ? "Edit Asset" : "Add New Asset"} className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
      ...
      <div className="space-y-4">
        ...
        {showPreviewModal && previewAsset && (
          <Modal open onClose={() => setShowPreviewModal(false)} title="Confirm Upload" className="bg-white rounded-lg p-6 shadow-xl max-w-sm mx-auto text-center">
