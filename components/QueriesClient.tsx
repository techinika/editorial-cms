...
export default function QueriesClient({ user }: QueriesClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Modal open={showDeleteModal} onClose={() => setShowDeleteModal(false)} title="Delete Query" className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
